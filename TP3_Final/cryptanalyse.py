...
upload_box.send_keys(
    ...
    # "C:/.../Python_secu_cryptage/TP3_Final/imagecypher-secret.png"
)
time.sleep(2)
...
for password in mots_de_passe:
    ...
    # Trouver le champ de texte du mot de passe et le saisir (+ cleaner le champ si un précédent texte à été saisi)
    password_input = driver.find_element(By.ID, "password-decode")
    password_input.clear()
    password_input.send_keys(password)
    
    # Trouver et cliquer sur le bouton "Réveler"
